    ...
    var DataMigrator = class {
        migrate() {
            return ctx.Misc.async(function*() {
                ...
                if (!needed) {
                    ...
                    browser.storage.local.set({ data_version: DATA_VERSION }, function() {
                    });
                    return;
                }
        ...
        isMigrationFromLocalStorageNeeded() {
            return new Promise(function(resolve, reject) {
                browser.storage.local.get({ data_version: null }, function(obj) {
        ...
        saveData(value) {
            return new Promise(function(resolve, reject) {
                browser.storage.local.set(value, function() {
                    if (browser.runtime.lastError) {
                        reject(browser.runtime.lastError);
                        return;
                    }
